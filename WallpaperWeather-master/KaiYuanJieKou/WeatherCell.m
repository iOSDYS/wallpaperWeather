...
+ (instancetype)cellWithTableview:(UITableView *)tableView WeatherData:(WeatherModel*)data{
    ...
    [cell setupWeatherTypeImage:data.weather];
    //2.更新天气显示数据
    cell.curTempLabel.text = [data.temp stringByAppendingString:@"°C"];
    cell.districtNameLabel.text = data.city;
    cell.weatherTypeLabel.text = data.weather;
    cell.HighOrLowTempLabel.text = [NSString stringWithFormat:@"Max.%@°C - Min.%@°C",data.temphigh,data.templow];
